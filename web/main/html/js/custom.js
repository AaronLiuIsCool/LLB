...
jQuery(document).ready(function($){
	...
	/* Add left navi bar control */
	$("#gear_cl a").click(function() {
		if($( "#gear_cl a" ).hasClass( "active" )){
			$( "#gear_cl a" ).removeClass( "active" );
		} else {
			$( "#gear_cl a" ).addClass( "active" );
			$( "#feeding_cl a" ).removeClass( "active" );
			$( "#bap_cl a" ).removeClass( "active" );
			$( "#mm_cl a" ).removeClass( "active" );
			$( "#wa_cl a" ).removeClass( "active" );
			$( "#toy_cl a" ).removeClass( "active" );
			$( "#has_cl a" ).removeClass( "active" );
			$( "#had_cl a" ).removeClass( "active" );
		}
	});

	$("#feeding_cl a").click(function() {
		if($( "#feeding_cl a" ).hasClass( "active" )){
			$( "#feeding_cl a" ).removeClass( "active" );
		} else {
			$( "#feeding_cl a" ).addClass( "active" );
			$( "#gear_cl a" ).removeClass( "active" );
			$( "#bap_cl a" ).removeClass( "active" );
			$( "#mm_cl a" ).removeClass( "active" );
			$( "#wa_cl a" ).removeClass( "active" );
	...
	$("#bap_cl a").click(function() {
		if($( "#bap_cl a" ).hasClass( "active" )){
			$( "#bap_cl a" ).removeClass( "active" );
		} else {
			$( "#bap_cl a" ).addClass( "active" );
			$( "#feeding_cl a" ).removeClass( "active" );
			$( "#gear_cl a" ).removeClass( "active" );
			$( "#mm_cl a" ).removeClass( "active" );
			$( "#wa_cl a" ).removeClass( "active" );
	...
	$("#mm_cl a").click(function() {
		if($( "#mm_cl a" ).hasClass( "active" )){
			$( "#mm_cl a" ).removeClass( "active" );
		} else {
			$( "#mm_cl a" ).addClass( "active" );
			$( "#feeding_cl a" ).removeClass( "active" );
			$( "#gear_cl a" ).removeClass( "active" );
			$( "#bap_cl a" ).removeClass( "active" );
			$( "#wa_cl a" ).removeClass( "active" );
	...
	$("#wa_cl a").click(function() {
		if($( "#wa_cl a" ).hasClass( "active" )){
			$( "#wa_cl a" ).removeClass( "active" );
		} else {
			$( "#wa_cl a" ).addClass( "active" );
			$( "#gear_cl a" ).removeClass( "active" );
			$( "#feeding_cl a" ).removeClass( "active" );
			$( "#bap_cl a" ).removeClass( "active" );
			$( "#mm_cl a" ).removeClass( "active" );
	...
	$("#toy_cl a").click(function() {
		if($( "#toy_cl a" ).hasClass( "active" )){
			$( "#toy_cl a" ).removeClass( "active" );
		} else {
			$( "#toy_cl a" ).addClass( "active" );
			$( "#gear_cl a" ).removeClass( "active" );
			$( "#feeding_cl a" ).removeClass( "active" );
			$( "#bap_cl a" ).removeClass( "active" );
			$( "#mm_cl a" ).removeClass( "active" );
	...
	$("#has_cl a").click(function() {
		if($( "#has_cl a" ).hasClass( "active" )){
			$( "#has_cl a" ).removeClass( "active" );
		} else {
			$( "#has_cl a" ).addClass( "active" );
			$( "#gear_cl a" ).removeClass( "active" );
			$( "#feeding_cl a" ).removeClass( "active" );
			$( "#bap_cl a" ).removeClass( "active" );
			$( "#mm_cl a" ).removeClass( "active" );
	...
	$("#had_cl a").click(function() {
		if($( "#had_cl a" ).hasClass( "active" )){
			$( "#had_cl a" ).removeClass( "active" );
		} else {
			$( "#had_cl a" ).addClass( "active" );
			$( "#gear_cl a" ).removeClass( "active" );
			$( "#feeding_cl a" ).removeClass( "active" );
			$( "#bap_cl a" ).removeClass( "active" );
			$( "#mm_cl a" ).removeClass( "active" );
